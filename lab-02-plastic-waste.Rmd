...
The violin plots more effectively show the density of the plastic waste per capita and makes apparent which continents have the most plastic waste per capita.  Meanwhile, the box plots more effectively show the outliers and median of plastic waste per capita for each continent.
...
The relationship between the plastic waste per capita and mismanaged plastic waste per capita is that most of the plastic waste is in all of the continents is mismanaged.
