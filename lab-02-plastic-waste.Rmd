...
In this graph, you can see that Africa has the highest rate of plastic waste per capita, while South America has the least.
...
We define the color and fill by mapping aesthetics because they are linked to the data variables and we define the alpha level as a characteristic of the plotting geom because customizing it helps us explore the plot.
...
The violin plots more effectively show the density of the plastic waste per capita and make apparent which continents have the most plastic waste per capita.  Meanwhile, the box plots more effectively show the outliers and median of plastic waste per capita for each continent.
...
The relationship between the plastic waste per capita and mismanaged plastic waste per capita is that most of the plastic waste in all of the continents is mismanaged.
...
It seems as though nearly all of Africa's plastic waste per capita is unmanaged, while it varies in other countries. For example, in North America most waste is unmanaged, but there are outliers that show that some waste is managed.
...
It looks like, out of the total population, the coastal population has less plastic waste per capita and represents some of the outliers on the total population scatterplot.
...
The line represents the general trend of costal population's plastic waste per capita and the dots represent the more specific information about costal population's plastic waste per capita.
